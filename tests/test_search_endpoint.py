    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                " lt 2019-02-12T23:20:50.000Z&$orderby=PublicationDate desc&$top=10000&$skip=0&$expand=Attributes",
                status.HTTP_200_OK,
            ),
            (
                ROUTER_PREFIX_AUXIP,
            ...
            (
                ...
                " lt 2019-02-12T23:20:50.000Z&$orderby=PublicationDate desc&$top=10000&$skip=0",
                status.HTTP_200_OK,
            ),
            (
                ROUTER_PREFIX_CADIP,
