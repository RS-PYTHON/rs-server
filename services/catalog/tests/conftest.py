...
@pytest.fixture(scope="session", name="feature_toto_s2_l3_1")
def feature_toto_s2_l3_1_fixture() -> Feature:  # pylint: disable=missing-function-docstring
    return a_feature("toto", "f7f164c9-cfdf-436d-a3f0-69864c38ba2a", "S2_L3")
...
def setup_database(
    ...
    add_feature(client, feature_toto_s2_l3_1)
