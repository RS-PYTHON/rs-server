...
class AdgsDownloadStatus(Base):
    ...
    @classmethod
    def get(cls, db: Session, name: str | Column[str], raise_if_missing=True) -> AdgsDownloadStatus:
    ...
    @classmethod
    def get_if_exists(cls, *args, **kwargs) -> AdgsDownloadStatus | None:
