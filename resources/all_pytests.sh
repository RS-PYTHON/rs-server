...
# Remove existing coverage and JUnit reports
...
# Skip the dummy directory coverage to avoid invalid paths
# Instead, ensure the coverage report is properly formatted
